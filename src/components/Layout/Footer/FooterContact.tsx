    ...
    <div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-4">
          <div className="footer-qr-container w-22 h-22 shrink-0">
            <div className="w-full h-full bg-gray-100 rounded-md flex items-center justify-center">
              ...
              >
                ...
                <rect
                  ...
                  fill="#0a2e5c"
                />
                <rect x="45" y="7" width="12" height="12" rx="1" fill="white" />
                <rect
                  x="48"
                  y="10"
                  width="6"
                ...
                <rect
                  ...
                  fill="#0a2e5c"
                />
                <rect x="7" y="45" width="12" height="12" rx="1" fill="white" />
                <rect
                  x="10"
                  y="48"
                  width="6"
          ...
          <div className="flex flex-col gap-1.5">
            <span className="font-sans text-[12px] font-semibold text-text-inverse uppercase tracking-wide">
              Quét mã QR
            </span>
            <span className="font-sans text-[11px] font-normal text-text-inverse-muted leading-normal">
              Để truy cập website
              <br />
              nhanh chóng
            </span>
