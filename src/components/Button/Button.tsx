...
const variantClasses: Record<ButtonVariant, string> = {
  "primary-orange":
    "bg-brand-orange text-text-inverse border-0 rounded-sm px-5 py-2 hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed",
  "primary-green":
    "bg-brand-green text-text-inverse border-0 rounded-sm px-6 py-2.5 hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed",
  "outline-white":
    "bg-transparent text-text-inverse rounded-sm px-6 py-2.5 border-2 border-white hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed",
  "link-navy":
